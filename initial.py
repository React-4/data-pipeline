...
from data_collectors.disclosure_chatgpt_api import process_disclosures
...
# 공시 데이터 처리
kospi_disclo_df = pd.read_csv("disclosure/kospi_disclo.csv", dtype={"stock_code": str}, encoding="utf-8-sig")
process_disclosures(kospi_disclo_df, stockInfo_df, output_path="disclosure/result_table.csv")
